...
HD_PWD='/home/calvin0901/dspic/fft16/fft_16/fft_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_16.tcl
